...
func QuestionHandler(w http.ResponseWriter, r *http.Request) {
	...
	openAIResponse, tokens, err := callOpenAI(clientToUse, prompt, model,
		"Act as a Midjourney prompt bot. Pretend you are an award-winning photographer and pick a camera and camera shot and include as many details as possible about the composition. Place the details about the camera at the end of the prompt the prompt, do not repeat yourself.  Write a detailed prompt from the user's input:",
		512)
